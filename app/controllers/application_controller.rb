...
# セプテーニのcompany_idをいれる。今は暫定
  $showoff_timeline = [1,2,3,32,30,79,37]
  $showoff_ranking = [1,2,3,32,30,79,37]
  $showoff_hashtag = [1,2,3,32,30,79,37]
  $ban_edit_name = [1,2,3,32,30,79,37]
  $allow_nickname = [1,2,3,32,30,79,37]
  $use_select = [1,2,3,32,30,79,37]
  $no_manager = [1,2,3,32,30,79,37]
  $nicknames = {
    1 => "同僚さん",
    2 => "白パンさん",
    3 => "ほしがりさん",
