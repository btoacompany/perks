...
ActiveRecord::Schema.define(version: 20170227032622) do
  ...
  create_table "company", force: :cascade do |t|
    ...
    t.string   "invite_link",       limit: 255
  ...
  create_table "posts", force: :cascade do |t|
    t.integer  "company_id",        limit: 4,               null: false
    t.integer  "user_id",           limit: 4,               null: false
    t.string   "receiver_id",       limit: 191,             null: false
    ...
    t.integer  "deliver_post_mail", limit: 1,   default: 0, null: false
    t.datetime "create_time",                               null: false
    t.datetime "update_time",                               null: false
    t.integer  "delete_flag",       limit: 1,   default: 0
  end
  ...
  create_table "request_rewards", force: :cascade do |t|
    ...
    t.integer  "rewards_prizy_id",     limit: 4, default: 0
    t.integer  "status",               limit: 1, default: 0
    t.integer  "deliver_request_mail", limit: 1, default: 0, null: false
    t.integer  "deliver_approve_mail", limit: 1, default: 0, null: false
    t.datetime "create_time",                                null: false
    t.datetime "update_time",                                null: false
    t.integer  "delete_flag",          limit: 1, default: 0
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.integer  "plan",                limit: 1,   default: 0, null: false
    t.integer  "send_approved",       limit: 1,   default: 0, null: false
    t.integer  "send_post_mail",      limit: 1,   default: 0, null: false
    t.integer  "deliver_invite_mail", limit: 1,   default: 0, null: false
    t.integer  "verified",            limit: 1,   default: 0, null: false
    t.string   "password",            limit: 191
    t.string   "salt",                limit: 191
